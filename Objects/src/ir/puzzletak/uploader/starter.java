...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "ir.puzzletak.uploader", "ir.puzzletak.uploader.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.puzzletak.uploader.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
